...
#
# Generated by Vivado on Wed Apr 12 12:17:25 -0400 2023
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2022.2.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../DDS_SineWave.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../DDS_SineWave.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
