...
HD_PWD='C:/Users/ysapkota/Downloads/DDS_SineWave/DDS_SineWave/DDS_SineWave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Driver.tcl
