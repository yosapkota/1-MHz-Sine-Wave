...
HD_PWD='C:/Users/ysapkota/Downloads/DDS_SineWave/DDS_SineWave/DDS_SineWave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Driver.tcl -notrace
